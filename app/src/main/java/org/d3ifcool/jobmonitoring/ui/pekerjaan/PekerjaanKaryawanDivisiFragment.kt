...
import org.d3ifcool.jobmonitoring.databinding.FragmentPekerjaanKaryawanDivisiBinding
import org.d3ifcool.jobmonitoring.model.DivisiModel
import org.d3ifcool.jobmonitoring.model.Preference

class PekerjaanKaryawanDivisiFragment : Fragment() {

    private var _binding: FragmentPekerjaanKaryawanDivisiBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentPekerjaanKaryawanDivisiBinding.inflate(inflater, container, false)
        getDivisi()
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        divisiAdapter = PekerjaanFilterDivisiAdapter(arrayListOf(),object : PekerjaanFilterDivisiAdapter.OnAdapterListener {
            override fun filter(divisi: DivisiModel, v: View) {
                ...
                pref.prefpembedapekerjaan = "karyawan"
                findNavController().navigate(R.id.action_pekerjaanKaryawanDivisiFragment_to_pekerjaanFilterKaryawanFargment)
            }
        })
